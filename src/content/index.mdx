...
weight: 10
---
import { Snippet } from "../components/TemplateGallery/Snippet"
import { Boilerplate } from "../components/TemplateGallery/Boilerplate"
...
<ul class="tutorial-list">
  <li class="tutorial-item">
    <a href="/tutorials/build-an-application">
      <img src="/media/chat-bot.svg" alt="chat bot icon"/>
    </a>
  ...
  <li class="tutorial-item">
    <a href="/tutorials/build-a-serverless-function">
      <img src="/media/qr-generator.svg" alt="QR icon" />
    </a>
  ...
  <li class="tutorial-item">
    <a href="/tutorials/deploy-a-react-app">
      <img src="/media/cache-website.svg" alt="caching a site" />
    </a>
...
<Boilerplate endpointId="hello_world"/>
<Boilerplate endpointId="hello_world_rust"/>
</section>
<section class="snippet template-wrapper">
    <Snippet endpointId="bulk_redirects"/>
    <Snippet endpointId="send_raw_html"/>
</section>
...
<section class="reference-links">
  ...
  <div>
    ...
    <p>Build and deploy with integrated tools</p>index.mdx
  </div>
</section>
